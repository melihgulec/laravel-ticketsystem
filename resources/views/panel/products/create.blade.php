<x-layouts.with-title title="Products" subtitle="Make product operations in this page.">
    ...
    <div class="flex flex-col">
        <div class="flex justify-end">
            <a href="/admin/products/add" class="px-4 py-2 bg-blue-500 rounded-md transition-all duration-100 hover:bg-blue-600 w-24 flex flex-row items-center justify-center text-white mb-4">
